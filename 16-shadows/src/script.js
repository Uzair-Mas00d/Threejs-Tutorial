...
const directionalLightCameraHepler = new THREE.CameraHelper(directionalLight.shadow.camera)
directionalLightCameraHepler.visible = false
scene.add(directionalLightCameraHepler)
