...
const bricksAmbientOcclusionTextures = textureLoader.load(
...
const grassAmbientOcclusionTextures = textureLoader.load(
...
const door = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({
    ...
    displacementMap: doorHeightTexture, // we need to increase number of vertices to use this texture
...
const tick = () => {
  ...
  ghost3.position.z = Math.sin(ghost3Angle) * (7 + Math.sin(elapsedTime * 0.55))
