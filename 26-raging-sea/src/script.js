...
import waterFragnmentShader from "./shaders/water/fragnment.glsl";
...
const waterMaterial = new THREE.ShaderMaterial({
  ...
  fragmentShader: waterFragnmentShader,
  uniforms: {
    uTime: { value: 0 },
...
gui
  .add(waterMaterial.uniforms.uSmallWaveItreation, "value")
  .min(0)
  .max(8)
  .step(1)
  .name("uSmallWaveItreation");
gui
