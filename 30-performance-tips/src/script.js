...
//     geometry.rotateX((Math.random() - 0.5) * 10 * Math.PI * 2)
//     geometry.rotateY((Math.random() - 0.5) * 10 * Math.PI * 2)
...
// mesh.instanceMatrix.setUsage(THREE.DynamicDrawUsage) // For updating matrices in tick
// scene.add(mesh)
...
const shaderMaterial = new THREE.ShaderMaterial({
    ...
    fragmentShader: `
        ...
        void main()
        {
            ...
            // vec3 finalColor = vec3(0.0); Do calculation in Vertex Shader
